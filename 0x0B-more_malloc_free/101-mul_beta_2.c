...
/**
  ...
  * @temp: Pointer to last byte in allocated memory.
  * Decrement as the memory gets filled.
...
/**
  ...
  * @temp: Pointer to the last byte of the memory containing the
  * most recent product of num1 and a digit from num2.
  * Decrement for every loop.
  * @front: Pointer to the 1st byte of the memory containing the most recent
...
int main(int argc, char **argv)
{
	...
	temp = _calloc0(len1 + 1, sizeof(*temp));
